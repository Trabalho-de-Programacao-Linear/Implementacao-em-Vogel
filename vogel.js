...
function vogel(table) {
    ...
    if (maxValueColumn >= maxValueLine) {
        ...
        // let postionValueMinColumn = getPositionValueMinColumn(auxTable, postionValueMaxLine);
        ...
        // let positionValueMinLine = getPositionValueMinLine(auxTable, positionValueMaxColumn);
